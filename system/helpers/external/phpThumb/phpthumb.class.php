...
//echo $maxwidth.'x'.$maxheight.'<hr>';
	...
	public function ExtractEXIFgetImageSize() {
		...
		if (phpthumb_functions::version_compare_replacement(PHP_VERSION, '4.2.0', '>=') && function_exists('exif_read_data')) {
			if(isset($this->getimagesizeinfo[2])) switch (@$this->getimagesizeinfo[2]) {
				case IMAGETYPE_JPEG:
		...
		if (isset($this->getimagesizeinfo[2]) && function_exists('exif_thumbnail') && (@$this->getimagesizeinfo[2] == IMAGETYPE_JPEG)) {
